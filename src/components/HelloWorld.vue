    ...
    >
      ...
      >
        ...
        <v-col cols="11" md="8" sm="11">
          <p id="skillz">
            Web Development | Interface Design | UX | Web Design
          </p>
        </v-col>
      </div>
    </v-img>
      ...
      <div class="wrapper mt-4">
        <ul>
          <a
            ...
            data-aos-easing="ease-in-out"
            data-aos-once="true"
            href="https://www.instagram.com/nimit.trevadiya3"
            target="_blank"
          >
            <li class="instagram">
          ...
          <a
            ...
            data-aos-easing="ease-in-out"
            data-aos-once="true"
            href="https://www.linkedin.com/in/nimittrevadiya/"
            target="_blank"
          >
            <li class="linkedin">
          ...
          <a
            ...
            data-aos-easing="ease-in-out"
            data-aos-once="true"
            href="https://github.com/nimit0703"
            target="_blank"
            ><li class="github">
