<template>
  <v-container justify-center data-aos="fade-up" data-aos-offset="50" data-aos-delay="1" data-aos-duration="600"
    ...
    <div v-show="!detailProject">
      ...
      <v-row class="d-flex justify-center">
        <v-col cols="10" md="10" sm="10">
          <v-card id="cardderino" class="hvr-glow mt-12 activeState mr-5" width="220" height="370" color="transparent"
            dark hover rounded :ripple="{ class: 'indigo--text' }" outlined v-scroll-to="'#feelsGoodMan'"
            v-for="project in computedObj" :key="project.id" @click="detailProject = project">
            <v-img position="center" height="auto" width="220" src="../assets/logo.png"/>
              <li class="case">
    ...
    <v-col cols="12" md="12">
      <div id="projectsBtn" class="d-flex justify-center">
        <v-btn id="buttonMain" class="hvr-glow pa-2 px-15 mt-7" v-scroll-to="'#title'" @click="toggleProjects"
          v-show="!detailProject" outlined ripple color="indigo accent-2">{{ limit == 4 ? "More" : "Less" }}
          Projects</v-btn>
      </div>
      <div class="d-flex flex-row-reverse col-md-11">
        <v-btn id="buttonMain" class="hvr-glow activeState pa-2 px-15 mt-7" v-scroll-to="'#feelsGoodMan'"
          @click="detailProject = project" v-show="detailProject" outlined ripple color="indigo accent-2">Back</v-btn>
      </div>
    </v-col>
  </v-container>
</template>
