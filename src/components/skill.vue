<template>
  <v-container>
    <div class="d-flex flex-column d-sm-flex flex-sm-row offset-md-1 mt-9">
      <v-col data-aos="fade-up" data-aos-offset="50" data-aos-delay="1" data-aos-duration="600"
        data-aos-easing="ease-in-out" data-aos-once="true" cols="12" md="5" sm="5">
        <h1 class="pb-5">Skills & Competencies</h1>
        <p>
          I am fully capable of building a lot of things. Whether it's a full stack application, a webshop or just a
          website for you - I got you.
          ...
          knowledge about various practices,
          Object-oriented programming , architectures and
          industry standards. <br />
          HLD and LLD is another field I've been building my knowledge in.
          <!-- <span><a href="https://drive.google.com/file/d/16DFNjQhOWYENe7AtcvGRQM81132vWGB1/view?usp=sharing"
              target="_blank">Digital Google Garage Certificate</a></span>. -->
        </p>
        <v-btn id="buttonMain" class="hvr-glow pa-2 px-10 mt-7" href="https://github.com/nimit0703" target="_blank"
          outlined ripple color="indigo accent-2">Github</v-btn>
      </v-col>
      <v-col class="offset-md-1 offset-sm-1" cols="12" md="6" sm="5">
        <div id="myCanvasContainer" class="d-flex justify-center">
          <canvas width="auto" height="400" id="myCanvas">
            ...
            <ul>
              <a href="javascript:function() { return false; }">Figma</a>
              ...
              <a href="javascript:function() { return false; }">Vuex</a>
              ...
              <a href="javascript:function() { return false; }">React</a>
              <a href="javascript:function() { return false; }">Redux</a>
              <a href="javascript:function() { return false; }">MUI</a>
              <a href="javascript:function() { return false; }">NodeJS</a>
              <a href="javascript:function() { return false; }">Web socket</a>
              ...
              <a href="javascript:function() { return false; }">Java</a>
              ...
              <a href="javascript:function() { return false; }">Vitest</a>
              ...
              <a href="javascript:function() { return false; }">TypeScript</a>
              <a href="javascript:function() { return false; }">MongoDB</a>
              <a href="javascript:function() { return false; }">Axios</a>
            </ul>
          </canvas>
        </div>
      </v-col>
